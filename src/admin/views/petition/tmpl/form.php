...
<script type="text/javascript">
	function submitbutton(pressbutton) {
		...
		// do field validation
		<?php /*TODO is surname supposed to be a field for petition-name/title?*/ ?>
		if (form.surname.value == "") {
			alert( "<?php echo JText::_( 'petitions form surname missing', true ); ?>" );
		} else if (form.catid.value == "0"){
			alert( "<?php echo JText::_( 'petitions form category missing', true ); ?>" );
		} else if (form.mail.value == ""){
			alert( "<?php echo JText::_( 'petitions form email missing', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
