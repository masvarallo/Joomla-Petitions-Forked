...
<tr id="voir" style="display:inline;"><td align="center"><h1><a href="javascript:formaffiche()" /><?php echo JText::_( 'Signer la petition', true ); ?></a></h1></td></tr>
<tr id="cache" style="display:none;"><td align="center"><a href="javascript:formcache()" /><?php echo JText::_( 'Masquer le formulaire', true ); ?></a></td></tr><br>
