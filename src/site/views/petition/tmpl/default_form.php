...
function submitbutton()
{
	...
	<?php if ($this->params->get('champ_url',0)) : ?>	
		...
		alert( "<?php echo JText::_( 'You must have a valide url.', true ); ?>" );
			return false;
	<?php endif; ?>	
	<?php if ($this->params->get('use_captcha',0)) : ?>	
	} else if (document.getElementById('ck_captcha_code').value == ""){
		alert( "<?php echo JText::_( 'You must have a code captcha', true ); ?>" );
	<?php endif; ?>	
	return false;
	} else {
		//submitform( pressbutton );
		//document.petitionForm.action = 'index.php';
...
function submitbutton( pressbutton ) {
	var form = document.petitionForm;
	var r = new RegExp("[\<|\>|\"|\'|\%|\;|\(|\)|\&|\+|\-]", "i");
	...
	if (form.name2.value == "") {
		...
		alert( "Les mots de passe saisis ne correspondent pas, merci de réssayer." );
	} else if (r.exec(form.password.value)) {
		alert( "Merci de saisir un Mot de passe valide.  Pas d\'espace, avec au moins 4 caractères et il doit contenir <strong>uniquement</strong> des lettres et nombres" );
	} else {
		form.submit();
	}
}*/
...
<tr>
	<td width="16%">
		<label for="petitiontitle">
			<?php echo JText::_( 'Civilite' ); ?> :		</label>	</td>
	<td width="84%">
		...
		<option ><?php echo JText::_( 'Civilite3' ); ?></option>	</td>
</tr>
<tr>
	<td width="16%">
...
<tr>
	...
	//include("components/com_petitions/liste_pays_french.php");
...
<tr>
	...
	<td>
		<textarea class="inputbox" cols="30" rows="6" id="petitioncomment" name="comment" style="width:330px" onkeyup="Compter(this, this.form.CharRestant);"><?php echo $this->escape( $this->petition->comment);?></textarea><br>Nombre de caractères restant : <input type='text' name='CharRestant' size='2' disabled='disabled'></td>
</tr>
<?php endif; ?>
<?php if ($this->params->get('use_captcha',0)) : ?>
<tr>
...
<?php endif; ?>
	...
	<td colspan="2" height="40">
		<?php echo JText::_( 'Champs obligatoires' ); ?></tr>
</table>
